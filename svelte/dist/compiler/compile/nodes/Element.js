...
function get_namespace(parent, element, explicit_namespace) {
    ...
    if (!parent_element) {
        return explicit_namespace || (svg.test(element.name)
            ? namespaces_1.namespaces.svg
            : null);
    }
    if (svg.test(element.name.toLowerCase()))
        return namespaces_1.namespaces.svg;
...
class Element extends Node_1.default {
        ...
        info.attributes.forEach(node => {
            switch (node.type) {
                ...
                case 'Binding':
                    ...
                    break;
                case 'Class':
                    this.classes.push(new Class_1.default(component, this, scope, node));
                    break;
                case 'EventHandler':
                    this.handlers.push(new EventHandler_1.default(component, this, scope, node));
                    break;
                case 'Let': {
                    const l = new Let_1.default(component, this, scope, node);
                    this.lets.push(l);
                ...
                case 'Transition':
                    {
                        const transition = new Transition_1.default(component, this, scope, node);
                        if (node.intro)
                ...
                case 'Animation':
                    this.animation = new Animation_1.default(component, this, scope, node);
                    break;
                default:
        ...
        this.attributes.forEach(attribute => {
            ...
            if (name.startsWith('aria-')) {
                ...
                if (!aria_attribute_set.has(type)) {
                    const match = fuzzymatch_1.default(type, aria_attributes);
            ...
            if (name === 'role') {
                ...
                if (value && !aria_role_set.has(value)) {
                    // @ts-ignore
                    const match = fuzzymatch_1.default(value, aria_roles);
    ...
    validate_bindings() {
        ...
        this.bindings.forEach(binding => {
            ...
            if (name === 'value') {
            ...
            else if (patterns_1.dimensions.test(name)) {
                ...
                else if (names_1.is_void(this.name)) {
                    component.error(binding, {
                        code: 'invalid-binding',
        ...
        this.handlers.forEach(handler => {
            ...
            handler.modifiers.forEach(modifier => {
                if (!valid_modifiers.has(modifier)) {
                    component.error(handler, {
                        code: 'invalid-event-modifier',
                        message: `Valid event modifiers are ${list_1.default(Array.from(valid_modifiers))}`
                    });
                }
                if (modifier === 'passive') {
    ...
    add_css_class() {
        ...
        if (class_attribute && !class_attribute.is_true) {
            if (class_attribute.chunks.length === 1 && class_attribute.chunks[0].type === 'Text') {
                ...
                class_attribute.chunks.push(new Text_1.default(this.component, this, this.scope, {
                    type: 'Text',
                    data: ` ${id}`,
                    synthetic: true
                }));
            ...
            this.attributes.push(new Attribute_1.default(this.component, this, this.scope, {
                type: 'Attribute',
                name: 'class',
