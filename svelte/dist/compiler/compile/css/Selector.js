...
const gather_possible_values_1 = require("./gather_possible_values");
...
function attribute_matches(node, name, expected_value, operator, case_insensitive) {
    ...
    for (const chunk of attr.chunks) {
        ...
        if (chunk.type === 'Text') {
            ...
            gather_possible_values_1.gather_possible_values(chunk.node, current_possible_values);
        }
        // impossible to find out all combinations
        if (current_possible_values.has(gather_possible_values_1.UNKNOWN))
            return true;
    ...
    prev_values.forEach(prev_value => possible_values.add(prev_value));
    if (possible_values.has(gather_possible_values_1.UNKNOWN))
        return true;
